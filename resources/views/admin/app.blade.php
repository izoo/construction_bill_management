...
<link rel="stylesheet" type="text/css" href="backend/css/icheck-bootstrap.min.css"/>
...
<body id="app" class="app sidebar-mini rtl">
      ...
      <form id="registerUser" class="card-body" method="POST">
        <div>
            ...
            <div class="form-group">
                    ...
                    <input class="form-control"name="name" id="name" type="text" aria-describedby="emailHelp" placeholder="">
        ...
        <div class="row">
            ...
            <div class="form-group">
                    ...
                    <input class="form-control" name="email" id="email" type="email" aria-describedby="emailHelp" placeholder="">
        ...
        <div class="row">
            ...
            <div class="form-group">
            <select id="role-select-user" name="role_select_user" class="form-control input-lg selectpicker">
...
<div class="row">
            ...
            <div class="form-group">
                    <label for="material">Phone Number</label>
                    <input class="form-control" name="site_phone_number" id="site_phone_number" type="text" aria-describedby="emailHelp" placeholder="">
            ...
            <div class="form-group">
                    <label for="material">Email</label>
                    <input class="form-control"name="site_email" id="site_email" type="text" aria-describedby="emailHelp" placeholder="">
    ...
    <div class="modal-content w3-padding-left w3-padding-right">
      ...
      <form id="registerEditUser" class="card-body" method="POST">
        ...
        <div>
            ...
            <div class="form-group">
                    <label for="material">Name</label>
                    <input class="form-control"name="nameu" id="nameu" type="text" aria-describedby="emailHelp" placeholder="">
        ...
        <div class="col-sm-6 col-lg-6 col-md-6">
            <div class="form-group">
                    <label for="material">Email</label>
                    <input class="form-control"  name="emailu" type="email" aria-describedby="emailHelp" placeholder="" id="emailu">
      ...
      <div class="row">
            ...
            <label>Select Role</label>
            <div class="form-group">
            <select id="role-select-useru" name="role_select_useru" class="form-control input-lg">
...
<div class="col-sm-12 col-lg-12 col-md-12  mpesa_code" style="display:none">
  ...
  <div class="modal-dialog" style="width:90%;height:80%;">
    ...
    <div class="modal-content w3-padding-left w3-padding-right">
      ...
      <input type="hidden" name="logged_in" class="logged_in" id="logged_in" value="<?php  echo Auth::user()->user_name ?>">
...
<td id="grand_total_expense"></td>
  ...
  <div class="modal-dialog" style="width:100%">
    ...
    <div class="modal-content w3-padding-left w3-padding-right">
      ...
      <input type="hidden" name="hidden_expense_next_id" id="hidden_expense_next_id">
...
<div class="col-sm-4 col-lg-4 col-md-4" id="bank_expenseu">
<div class="form-group">
            <label for="price">Bank Name</label>
            <input type="text" name="expense_bank_nameu" id="expense_bank_nameu" class="form-control" required/>
          </div>
          </div>   
         
 
<div class="col-sm-4 col-lg-4 col-md-4" id="cheque_expenseu">
<div class="form-group">
            <label for="price">Cheque No</label>
            <input type="text" name="cheque_nou" id="cheque_nou" class="form-control" >
          </div>
          </div>   
          <div class="col-sm-4 col-lg-4 col-md-4" id="expense_codeu">
          <div class="form-group">
            <label for="price">MPESA CODE </label>
 ...
 <div class="col-sm-4 col-lg-4 col-md-4">
            <div class="input-group">
                    <label for="material">Expense Name</label>
                    <input type="text" name="expenseu" class="form-control" id="expenseu">
          ...
          <div class="form-group">
            ...
            <input type="number" name="expense_quantityu" id="expense_quantityu" class="form-control" required/>
          </div>
          </div> 
          <div class="col-sm-4 col-lg-4 col-md-4">
          <div class="form-group">
            <label for="price">Unit Cost </label>
            <input type="number" name="expense_unit_costu" id="expense_unit_costu" class="form-control" required/>
          </div>
          </div>
...
<script src="backend/js/bootstrap.min.js"></script>
    ...
    <script src="backend/js/plugins/icheck.min.js"></script>
...
function fetchRoles()
{
  $.ajax({
    ...
    success:function(data)
    {
      var roles='<option value="" disabled></option>' +
      '<option value="">Select Role</option>' +
          '<option value="NEW" >New Role</option>';
          var role='<option value="" disabled></option>' +
      '<option value="">Select Role</option>';
      $.each(data,function(index,element){
        //alert(element.role_name);
         roles += '<option value="' + element.role_name + '">' + element.role_name + '</option>';
      role +=  '<option value="' + element.id + '">' + element.role_name + '</option>';
      });
      //alert(roles)
      $('#role-select').html(roles);
      $('#role-select-user').html(role);
      $('#role-select-useru').html(role);
      $('#role-select').selectpicker('refresh');
      $('#role-select-user').selectpicker('refresh');
     // $('#role-select-useru').selectpicker('refresh');
    }
  })
}
...
$('#roleForm').on('submit',(function(e){
      ...
      $.ajax({
        ...
        beforeSend:function()
        {
          $('#save-roles').html('Adding Role....');

        },
        success:function(response)
        {
         if($.isEmptyObject(response.error_role))
         {
          swal({
            title:"Success",
          ...
          $("#save-roles").html('UPDATE');
         }
         else
         {
           $("#roleError").fadeIn(1000,function(){
            printErrorMsg(response.error_role);
            $("#save-roles").html('UPDATE');
           });
         }
        }
  ...
  $.ajax({
    ...
    success:function(response)
    {
      $.each(response,function(index,element){
            $('#'+element.permission).prop('checked',true);
          });
          $('#roleForm').on('submit',(function(e){
      e.preventDefault();
      $.ajax({
...
$(document).on('click','.deleteUser',function(){
  var id=$(this).attr('id');
  swal({
    title:"Are you sure you to remove this user ?",
...
$(document).on('click','.removePassword',function(){
  var id=$(this).attr('id');
  swal({
    title:"Are you sure you to remove this password ?",
    text:"This Action Cannot be Reverted",
    icon:"warning",
    buttons:true,
    dangerMode:true,
    ...
    $.ajax({
                  ...
                  data:{id:id},
									success:function(data)
									{
										swal({
												title:"Success",
												text:"Password Successfuly Removed",
												icon:"success",
												button:"OK"
											});
                     
											$('.data-passwords').DataTable().ajax.reload();
									
									}
                });
              }
               else {
    swal("Password Not Removed!");
  }
...
//  Check Permissions
//Bills Check All
$('#bills_check_all').click(function(){
   $('.check_bill').prop('checked',this.checked);
});
//End Bills Check
//Expense Check All
$('#expense_check_all').click(function(){
   $('.check_expense').prop('checked',this.checked);
});
//End Expense Check
//Material Check All
$('#material_check_all').click(function(){
   $('.check_material').prop('checked',this.checked);
});
//End Material Check
//Site Check All
$('#site_check_all').click(function(){
   $('.check_site').prop('checked',this.checked);
});
//End Site Check
//User Check All
$('#user_check_all').click(function(){
   $('.check_user').prop('checked',this.checked);
});
//End User Check
//User Check All
$('#password_check_all').click(function(){
   $('.check_password').prop('checked',this.checked);
});
//End User Check
...
$(document).on('click','.deleteMaterial',function(){
 ...
 // alert(bill_id);
  ...
  var combine_id = first_id + '_' + second_id;
  //alert(item_id);
	$.get("{{route('expense.index')}}" +'/' + combine_id+'/edit',function(data)
	{
    //var dat =  JSON.parse(data);
    //alert(data.item);
		$('#hidden_expense_id').val(first_id);
    $('#hidden_expense_next_id').val(second_id);
    //$('#hidden_details').val(item_id);
   $('#expenseu').val(data.expense_name);
   ...
   $('#expense_bank_nameu').val(data.bank_name);
   $('#expense_quantityu').val(data.quantity);
   $('#expense_unit_costu').val(data.unit_price);
	 //alert(data.item);
...
$('body').on('click','.editUser',function(){
  ...
  success:function(data)
  {
   ...
   $('#nameu').val(data.name);
	 $('#user_nameu').val(data.user_name);
   //$('#emailu').val(data.email);
	 $('#phone_numberu').val(data.phone_number);
   //$('#role-select-useru').selectmenu('refresh');
   $('#role-select-useru').val(data.role_id);
  // $('#role-select-useru').selectmenu('refresh', true);
   $('#emailu').val(data.email);
	 //alert(data.item);
...
//Add Expense On Mode of Payment Select Changes
...
//End 
//Edit Expense On Mode of Payment Select Changes
$(document).on('change','#mode_expenseu',function(){
                    var value= $(this).val();
                    
                    if(value=="cheque")
                    {
                      $('#bank_expenseu').fadeIn('slow');
                      $('#cheque_expenseu').fadeIn('slow');
                      $('#expense_codeu').fadeOut('slow');
                    
                      $('#mpesa_code_expenseu').val('');
                      

                    }
                    else if(value=="mpesa")
                    {
                      $('#bank_expenseu').fadeOut('slow');
                      $('#cheque_expenseu').fadeOut('slow');
                      $('#expense_codeu').show('slow');
                      $('#cheque_nou').val('');
                      $('#expense_bank_nameu').val('');
                    }
                    else if(value=="cash")
                    {
                      $('#bank_expenseu').hide('slow');
                      $('#cheque_expenseu').hide('slow');
                      $('#expense_codeu').hide('slow');
                      $('#cheque_nou').val('');
                      $('#expense_bank_nameu').val('');
                      $('#mpesa_code_expenseu').val('');
                    }
